...
public class MusicUtils {
	...
	public static Bitmap getAlbumBitmap(Context context, long song_id,
			long album_id, boolean allowdefalut, boolean small){
		Bitmap bp=null;
		bp=sArtCache.get(song_id);
		if(bp==null){
			bp=getArtwork(context, song_id, album_id, allowdefalut, small);
			sArtCache.put(song_id, bp);
		}
		return bp;
	}
